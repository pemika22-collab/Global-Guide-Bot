...
Extract if present:
- name: Full name (or null if not provided)
- phone_number: Phone number (or null if not provided)
- specialties: Array of specialties (or [] if not provided)
- languages: Array of languages (or [] if not provided)
- location: City/location (or null if not provided)
- gender: "male" or "female" (or null if not provided)
- bio: Brief bio/description (or null if not provided)
- experience_years: Years as number (or null if not provided)
