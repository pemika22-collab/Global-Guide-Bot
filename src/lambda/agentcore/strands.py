...
class StrandManager:
    ...
    def clear_strands(self, user_id: str):
        """Clear all strands for a user"""
        # This is a simple implementation - in production you might want to 
        # mark strands as inactive rather than delete them
        pass  # For now, strands will naturally expire or be overwritten
